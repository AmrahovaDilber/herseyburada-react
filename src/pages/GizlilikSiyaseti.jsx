    ...
    <main className="min-h-screen py-10  ">
      <div className="container  ">
        ...
        <p className="text-lg mb-6 text-gray-600">
          ...
          İttifaqının 2016/679 nömrəli Tənzimləməsinə uyğun olaraq qorunmasını
          təmin edir. Bu siyasət, məlumatlarınızı necə işlədiyimiz və sizə olan
        ...
        <section className="mb-6">
          ...
          <p className="text-base text-gray-600">
            ...
            ünvanınızı toplayırıq. Bu məlumatları istifadəçi hesabınızı yaratmaq
          ...
          <p className="text-base text-gray-600">
            ...
            ad-soyad və e-mailinizi toplayırıq. Bu məlumatları istifadəçi
          ...
          <p className="text-base text-gray-600">
            ...
            razılığınızı geri ala bilərsiniz.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-base text-gray-600">
            ...
            şəxsi məlumatlarınızı müvafiq dövlət orqanlarına ötürə bilərik.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside pl-5 text-gray-600">
            ...
            <li>
              <strong>Düzəliş Hüququ:</strong> Dəqiq olmayan və ya tamamlanmamış
              şəxsi məlumatlarınızı düzəltmək hüququ.
            </li>
            <li>
              <strong>Silinmə Hüququ:</strong> Müəyyən şərtlərdə şəxsi
              məlumatlarınızı silmək hüququ.
            </li>
            <li>
              <strong>Emalın Məhdudlaşdırılması Hüququ:</strong> Müəyyən
              şərtlərdə şəxsi məlumatlarınızın emalını məhdudlaşdırmaq hüququ.
            </li>
            <li>
              <strong>Emala İtiraz Hüququ:</strong> Müəyyən şərtlərdə şəxsi
              məlumatlarınızın emalına etiraz etmək hüququ.
            </li>
            <li>
              <strong>Məlumatların Daşınması Hüququ:</strong> Şəxsi
