...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`border-b-[1px] sticky top-0 bg-white z-[999] transition-transform duration-300 ${
      ...
      <footer className="fixed bottom-0 left-0 w-full bg-white shadow-md lg:hidden z-[999]">
        <div className="flex justify-around items-center py-2 border-t-[1px]">
        <Link
            to="/"
            className="flex flex-col items-center text-gray-700 hover:text-[#ff9130] transition duration-200"
          >
