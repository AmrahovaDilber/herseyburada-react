      ...
      <div className="w-[320px] flex items-center space-x-[24px]">
        <div className="size-[62px] flex items-center justify-center bg-[#FFFFFF] rounded-full">
          <div className="flex flex-col justify-center items-center">
            <p className="font-bold text-[16px] text-[#000000]">     <span>{timeLeft.hours}</span>
            </p>
        ...
        <div className="size-[62px] flex items-center justify-center bg-[#FFFFFF] rounded-full">
          <div className="flex flex-col justify-center items-center">
            <p className="font-bold text-[16px] text-[#000000]">{timeLeft.minutes}</p>
            <p className="font-normal text-[11px] text-[#000000]">Deqiqe</p>
          </div>
        </div>
        <div className="size-[62px] flex items-center justify-center bg-[#FFFFFF] rounded-full">
          <div className="flex flex-col justify-center items-center">
            <p className="font-bold text-[16px] text-[#000000]">{timeLeft.seconds}</p>
